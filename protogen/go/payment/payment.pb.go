...
import (
	transaction "github.com/shch989/my-grpc-proto/protogen/go/transaction"
...
type PaymentRequest struct {
	...
	TatalAmount   uint32                 `protobuf:"varint,3,opt,name=tatal_amount,json=total_amount,proto3" json:"tatal_amount,omitempty"`
...
func (x *PaymentRequest) GetTatalAmount() uint32 {
	if x != nil {
		return x.TatalAmount
	}
	return 0
}
...
var file_proto_payment_payment_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x22, 0x0a, 0x0c, 0x74, 0x61,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x68, 0x63, 0x68, 0x39, 0x38, 0x39, 0x2f, 0x6d, 0x79, 0x2d, 0x67,
